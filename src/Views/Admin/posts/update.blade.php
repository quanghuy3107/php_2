        ...
        <div class="relative overflow-x-auto  sm:rounded-lg">
            ...
            <form action="" class="max-w-sm mx-auto" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="PostsTitle" id="title" value="{{ $data['title'] ?? '' }}"
                ...
                <div class="mb-3">
                    ...
                    <select name="cate" id="cate">
                        @foreach ($dataCategory as $item)
                            <option value="{{ $item['id'] }}" @if ($data['cateId'] == $item['id']) selected @endif
                ...
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Thay
                    đổi</button>
                <a href="/admin/posts"
